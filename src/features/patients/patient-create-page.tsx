...
function CreateForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="mt-4 max-w-lg space-y-6">
      <fieldset className="space-y-3 p-6 rounded-card bg-card shadow-card">
      ...
      <fieldset className="space-y-2 p-6 text-sm rounded-card bg-card shadow-card">
      ...
      {duplicates && duplicates.length > 0 && (
        <div className="border-amber-400 bg-amber-50 p-6 text-sm rounded-card shadow-card">
