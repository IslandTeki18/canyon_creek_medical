...
import { SiteFooter, SiteNav, WRAP } from "./marketing-chrome";

type IconType = ComponentType<{ size?: number; strokeWidth?: number }>;

// Organic uses Lucide at stroke-width 2.75 for a rounder, heavier look.
function Icon({ as: As }: { as: IconType }) {
  return <As size={22} strokeWidth={2.75} />;
}
    ...
    <div className="flex flex-1 scroll-smooth flex-col overflow-x-clip bg-sand font-body text-ink">
      ...
      <main id="main-content" className="flex-1">
        ...
        <section className="relative">
          <div
            aria-hidden="true"
            className="pointer-events-none absolute top-[-200px] right-[-160px] z-0 h-[440px] w-[440px] rounded-full bg-sage-200"
          />
          <div className={`${WRAP} relative z-10 pt-16 pb-18`}>
            ...
            <div className="mt-8 flex flex-wrap gap-3.5">
              ...
              <a href="#services" className={CTA_SECONDARY}>
          ...
          <div className="grid items-center gap-[clamp(28px,5vw,80px)] md:grid-cols-[minmax(0,7fr)_minmax(0,5fr)]">
            <div>
              ...
              <p className="mt-0 mb-3.5 text-base leading-[1.7] text-ink/80">
                ...
                chemistry, physical health, nutrition, sleep, hormones, trauma
                and environment. Rather than relying on medication alone, we
                build comprehensive plans across the biological, psychological
                and lifestyle factors affecting your health.
              </p>
              <p className="m-0 text-base leading-[1.7] text-ink/80">
                Our goal is to become a comprehensive center for behavioral
                health and regenerative medicine — expanding what we offer while
                staying committed to compassionate, patient-centered care.
              </p>
            </div>
        ...
        <section className={`${WRAP} pt-18 pb-14`}>
          <figure className="m-0 max-w-[60ch]">
            <blockquote className="m-0 font-display text-[clamp(24px,2.8vw,34px)] leading-[1.35]">
              “They didn’t just adjust a prescription — they asked about my
              sleep, my history, my life. For the first time I felt like someone
              was treating the cause.”
            </blockquote>
